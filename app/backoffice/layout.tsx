    ...
    <div className="flex w-full min-h-screen bg-[#f8fafc] font-sans text-slate-800 text-left select-none">
      ...
      <aside className="w-[270px] bg-[#1e232d] text-slate-300 flex flex-col justify-between border-r border-slate-800 print:hidden select-none shrink-0 h-screen sticky top-0">
        <div>
          ...
          <nav className="p-2 space-y-1 text-xs font-semibold overflow-y-auto max-h-[calc(100vh-110px)] custom-scrollbar">
            ...
            <div className="border border-slate-800/80 rounded-lg overflow-hidden bg-slate-900/30">
              ...
              {openSections.fleet && (
                <div className="pl-6 pr-2 py-1 space-y-0.5 border-t border-slate-800 bg-[#161a22] text-[11px]">
                  <Link href="/backoffice/fleet" className={`block px-2.5 py-1.5 rounded transition-colors ${isLinkActive('/backoffice/fleet') ? 'bg-[#1a629b] text-white font-bold' : 'text-slate-400 hover:text-white'}`}>
                    Fleet Live Map & Dispatch
                  </Link>
                </div>
              )}
            </div>
            ...
            <div className="border border-slate-800/80 rounded-lg overflow-hidden bg-slate-900/30">
              ...
              {openSections.social && (
                <div className="pl-6 pr-2 py-1 space-y-0.5 border-t border-slate-800 bg-[#161a22] text-[11px]">
                  <Link href="/backoffice/social-crm" className={`block px-2.5 py-1.5 rounded transition-colors ${isLinkActive('/backoffice/social-crm') ? 'bg-[#1a629b] text-white font-bold' : 'text-slate-400 hover:text-white'}`}>
            ...
            <div className="border border-slate-800/80 rounded-lg overflow-hidden bg-slate-900/30">
              ...
              {openSections.operations && (
                <div className="pl-6 pr-2 py-1 space-y-0.5 border-t border-slate-800 bg-[#161a22] text-[11px]">
                  <Link href="/backoffice/operations" className={`block px-2.5 py-1.5 rounded transition-colors ${isLinkActive('/backoffice/operations') ? 'bg-[#1a629b] text-white font-bold' : 'text-slate-400 hover:text-white'}`}>
            ...
            <div className="border border-slate-800/80 rounded-lg overflow-hidden bg-slate-900/30">
              ...
              {openSections.customers && (
                <div className="pl-6 pr-2 py-1 space-y-0.5 border-t border-slate-800 bg-[#161a22] text-[11px]">
                  <Link href="/backoffice/customers" className={`block px-2.5 py-1.5 rounded transition-colors ${isLinkActive('/backoffice/customers') ? 'bg-[#1a629b] text-white font-bold' : 'text-slate-400 hover:text-white'}`}>
            ...
            <div className="border border-slate-800/80 rounded-lg overflow-hidden bg-slate-900/30">
              ...
              {openSections.accounting && (
                <div className="pl-6 pr-2 py-1 space-y-0.5 border-t border-slate-800 bg-[#161a22] text-[11px]">
                  <Link href="/backoffice/accounting" className={`block px-2.5 py-1.5 rounded transition-colors ${isLinkActive('/backoffice/accounting') ? 'bg-[#1a629b] text-white font-bold' : 'text-slate-400 hover:text-white'}`}>
                    General Ledger & COA
                  </Link>
                </div>
              )}
            ...
            <div className="border border-slate-800/80 rounded-lg overflow-hidden bg-slate-900/30">
              ...
              {openSections.hr && (
                <div className="pl-6 pr-2 py-1 space-y-0.5 border-t border-slate-800 bg-[#161a22] text-[11px]">
                  <Link href="/backoffice/hr" className={`block px-2.5 py-1.5 rounded transition-colors ${isLinkActive('/backoffice/hr') ? 'bg-[#1a629b] text-white font-bold' : 'text-slate-400 hover:text-white'}`}>
        ...
        <div className="p-3 border-t border-slate-800 bg-[#161a22] text-xs flex items-center justify-between">
          <div className="flex items-center gap-2">
            <div className="w-6 h-6 rounded-full bg-[#1a629b] text-white font-bold flex items-center justify-center text-[10px]">
              M
            </div>
