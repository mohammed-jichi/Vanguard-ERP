  ...
  return (
    <div className="relative w-full" ref={containerRef}>
      <button
        ...
        className="w-full flex items-center justify-between px-3 py-1.5 text-xs text-slate-700 bg-white border border-slate-300 rounded focus:outline-none focus:border-primary hover:border-slate-400 transition"
      >
        ...
        <div className="absolute right-0 top-full mt-1 w-full min-w-[240px] bg-white border border-slate-200 rounded shadow-lg z-50 p-2 text-xs animate-in fade-in zoom-in-95 duration-100">
          ...
          <div className="relative mb-2">
            ...
            <input
              ...
              placeholder="Search..."
              className="w-full pl-8 pr-3 py-1.5 text-xs border border-slate-300 rounded focus:outline-none focus:border-primary"
            />
          </div>
