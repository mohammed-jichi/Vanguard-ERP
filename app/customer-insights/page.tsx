...
import { UserCheck, Award, TrendingUp, DollarSign, Users, AlertCircle, PhoneCall, Star } from 'lucide-react';
...
export default function CustomerInsightsPage() {
  ...
  return (
    <div dir="rtl" className="w-full min-h-screen bg-slate-50 p-6 space-y-6 font-sans">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400 font-semibold mt-1">
              منتوجات زيت وزيتون الجنوب ش.م.م -- Vanguard ERP Customer Intelligence
            </p>
          </div>
        </div>
