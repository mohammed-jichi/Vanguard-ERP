      ...
      <div className="filters-container w-full max-w-[1400px] bg-white rounded-lg border border-slate-200 shadow-sm p-4 mb-4 print:hidden">
        <div className="flex justify-between items-start gap-6">
          <div className="flex-1 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4 max-w-[700px]">
            ...
            <select className="w-full"><option>All Branches</option></select>
            <select className="w-full"><option>All Invoices</option></select>
            <input type="text" placeholder="Search Customer..." className="w-full" />
        ...
        <div className="report-wrapper transition-transform duration-200 origin-top">
          ...
          <div className="w-full mt-1 overflow-x-auto print:overflow-visible pb-4">
            <table className="w-full min-w-[800px] border-collapse border-t border-b border-black text-[11px] whitespace-nowrap">
              ...
              <tbody>
                <tr className="font-bold"><td colSpan={9} className="py-1 px-1">Branch: Southern Olive Oil S.A.R.L</td></tr>
          ...
          <div className="w-full mt-1 overflow-x-auto print:overflow-visible pb-4">
            <table className="w-full min-w-[800px] border-collapse border-t border-b border-black text-[11px] whitespace-nowrap">
              <thead>
                <tr className="font-bold text-black border-b border-black">
                  <th className="py-1 px-1 text-left">Customer Name</th>
                  <th className="py-1 px-1 text-right">Total Amount</th>
                </tr>
              </thead>
              <tbody>
                <tr className="font-bold"><td colSpan={2} className="py-1 px-1">Group Name: Clients</td></tr>
                <tr>
                    <td className="py-1 px-1">Colonel Mahmoud Abboud Colonel Abboud</td>
                    <td className="py-1 px-1 text-right">0.00</td>
                </tr>
                <tr className="font-bold">
                    <td className="py-1 px-1 text-right">Total by Group:</td>
                    <td className="py-1 px-1 text-right">0.00</td>
                </tr>
              </tbody>
            </table>
...
// ==========================================
// 3. Transactions by Customers Details
// ==========================================
...
// ==========================================
// 1. Transactions By Employees (With Complex Footer)
// ==========================================
      ...
      <div className="filters-container w-full max-w-[1400px] bg-white rounded-lg border border-slate-200 shadow-sm p-4 mb-4 print:hidden">
        <div className="flex justify-between items-start gap-6">
          <div className="flex-1 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 max-w-[1000px]">
            ...
            <select className="w-full"><option>All Payment Types</option></select>
            <div className="flex items-center gap-2 mt-2">
              <label className="flex items-center gap-2 text-[12px] font-bold text-slate-800 cursor-pointer">
...
// ==========================================
// Transactions by Date by Payments Template
// ==========================================
export const TransactionsByDateByPaymentsTemplate = () => {
