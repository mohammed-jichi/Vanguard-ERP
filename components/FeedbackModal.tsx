...
export default function FeedbackModal({ isOpen, onClose }: FeedbackModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-5 overflow-y-auto">
      ...
      <div
        dir={dir}
        className="relative bg-white border border-slate-200 rounded-3xl shadow-2xl w-full max-w-lg overflow-hidden z-10 animate-zoomIn flex flex-col text-left rtl:text-right"
      >
        {/* Modal Header */}
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-base font-extrabold text-white">
                {t('feedback_suggestions_title', 'Enterprise Feedback & Suggestions')}
              </h2>
              <p className="text-[11px] text-slate-400">
                {t('feedback_suggestions_sub', 'Your feedback directly drives Vanguard ERP product upgrades')}
              </p>
            </div>
          </div>
