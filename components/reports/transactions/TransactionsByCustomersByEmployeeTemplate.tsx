...
interface TransactionsByCustomersByEmployeeTemplateProps {
  hideToolbar?: boolean;
...
export const TransactionsByCustomersByEmployeeTemplate: React.FC<TransactionsByCustomersByEmployeeTemplateProps> = ({
  hideToolbar = true,
  dynamicPeriodText,
