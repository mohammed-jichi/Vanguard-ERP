...
interface TransactionsByEmployeesByPaymentTemplateProps {
  hideToolbar?: boolean;
...
export const TransactionsByEmployeesByPaymentTemplate: React.FC<TransactionsByEmployeesByPaymentTemplateProps> = ({
  hideToolbar = true,
  dynamicPeriodText,
