...
interface TransactionsByCustomersByGroupsTemplateProps {
  hideToolbar?: boolean;
...
export const TransactionsByCustomersByGroupsTemplate: React.FC<TransactionsByCustomersByGroupsTemplateProps> = ({
  hideToolbar = true,
  dynamicPeriodText,
