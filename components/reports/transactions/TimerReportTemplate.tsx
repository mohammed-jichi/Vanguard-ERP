...
export const TimerReportTemplate = () => {
  ...
  const rows = [
    { time: '10:57:50 AM', vals: ['0.00', '0.00', '0.00', '1.00'] },
    { time: '11:42:15 AM', vals: ['0.00', '0.00', '0.00', '1.00'] },
    { time: '12:08:17 PM', vals: ['0.00', '0.00', '0.00', '1.00'] },
    { time: '01:20:48 PM', vals: ['0.00', '0.00', '0.00', '1.00'] },
    { time: '04:03:00 PM', vals: ['0.00', '0.00', '0.00', '1.00'] },
    { time: '05:36:19 PM', vals: ['0.00', '0.00', '1.00', '1.00'] },
    { time: '05:52:08 PM', vals: ['0.00', '0.00', '1.00', '1.00'] },
  ];
    ...
    <div className="w-full flex flex-col items-center bg-white min-h-screen">
      ...
      <div className="w-full max-w-[1400px] flex flex-col xl:flex-row justify-between items-start xl:items-center bg-slate-50 border border-slate-200 rounded-lg p-3 mb-6 gap-4 print:hidden shadow-sm mt-2">
        ...
        <div className="flex flex-wrap items-center gap-3 flex-1 w-full">
          ...
          <label className="flex items-center gap-1.5 text-[13px] font-bold text-slate-800 cursor-pointer">
          ...
          {!isFiltered ? (
            ...
            <div className="bg-white p-4">
              ...
              <div className="text-center mb-6 border-b-2 border-black pb-4">
                ...
                <h3 className="font-bold text-[14px] text-slate-700 mt-1">Timer Report Group by Transaction Count</h3>
                <div className="flex justify-between items-end text-[12px] font-bold w-full mt-4">
                  <div>Date: 28-Aug-2026</div>
                  <div>From Date: 01-Aug-2026 To Date: 31-Aug-2026</div>
                  <div>Page 1 of 1</div>
                </div>
              </div>
