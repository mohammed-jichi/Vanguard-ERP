      ...
      <div className="relative w-full max-w-4xl bg-white border-2 border-amber-500/40 rounded-3xl shadow-2xl overflow-hidden my-auto animate-in fade-in zoom-in-95 duration-200">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-extrabold text-sm text-white flex items-center gap-2">
                <span>Vanguard ERP Official License Certificate</span>
              ...
              <p className="text-[11px] text-slate-300">
                Official perpetual enterprise license authorized for Southern Olive Oil Products S.A.R.L
              </p>
            </div>
          </div>
        ...
        <div className="print:hidden p-4 bg-slate-100 border-t border-slate-200 flex flex-wrap items-center justify-between gap-3 text-xs">
          <span className="text-slate-600 font-medium">
            Status: <strong className="text-emerald-700 font-bold">100% Active & Unlocked</strong> for Southern Olive Oil Products S.A.R.L
          </span>
          <div className="flex items-center gap-2">
            <button
              onClick={handlePrint}
