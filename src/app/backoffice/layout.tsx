              ...
              <nav className="p-2 space-y-1.5 text-xs font-semibold">
                ...
                <div className="border border-[#b89542]/30 rounded-xl overflow-hidden bg-black/30 shadow-xs">
                  ...
                  {openSections.customers && (
                    <div className="pl-6 pr-2 py-1 space-y-0.5 border-t border-[#b89542]/20 bg-black/40 text-[11px]">
                      <Link href="/backoffice/customers" className={`block px-2.5 py-1 rounded transition-colors ${isLinkActive('/backoffice/customers') ? 'bg-gradient-to-r from-[#d4af37] to-[#8a703b] text-slate-950 font-bold shadow-xs' : 'text-amber-200/80 hover:text-white hover:bg-black/30'}`}>
                        Master Directory & KYC (PDF)
                      </Link>
                      <Link href="/backoffice/customers/invoices" className={`block px-2.5 py-1 rounded transition-colors ${isLinkActive('/backoffice/customers/invoices') ? 'bg-gradient-to-r from-[#d4af37] to-[#8a703b] text-slate-950 font-bold shadow-xs' : 'text-amber-200/80 hover:text-white hover:bg-black/30'}`}>
                        Accounts Receivable & Aging Invoices
                      </Link>
                      <Link href="/backoffice/customers/receipts" className={`block px-2.5 py-1 rounded transition-colors ${isLinkActive('/backoffice/customers/receipts') ? 'bg-gradient-to-r from-[#d4af37] to-[#8a703b] text-slate-950 font-bold shadow-xs' : 'text-amber-200/80 hover:text-white hover:bg-black/30'}`}>
                        Payment Receipts & Settlements
                      </Link>
                      <Link href="/backoffice/customers/statements" className={`block px-2.5 py-1 rounded transition-colors ${isLinkActive('/backoffice/customers/statements') ? 'bg-gradient-to-r from-[#d4af37] to-[#8a703b] text-slate-950 font-bold shadow-xs' : 'text-amber-200/80 hover:text-white hover:bg-black/30'}`}>
                ...
                <div className="border border-[#b89542]/30 rounded-xl overflow-hidden bg-black/30 shadow-xs">
                  ...
                  {openSections.accounting && (
                    <div className="pl-6 pr-2 py-1 space-y-0.5 border-t border-[#b89542]/20 bg-black/40 text-[11px]">
                      <Link href="/backoffice/accounting" className={`block px-2.5 py-1 rounded transition-colors ${isLinkActive('/backoffice/accounting') ? 'bg-gradient-to-r from-[#d4af37] to-[#8a703b] text-slate-950 font-bold shadow-xs' : 'text-amber-200/80 hover:text-white hover:bg-black/30'}`}>
                        Chart of Accounts (COA)
                      </Link>
                      <Link href="/backoffice/accounting/journal" className={`block px-2.5 py-1 rounded transition-colors ${isLinkActive('/backoffice/accounting/journal') ? 'bg-gradient-to-r from-[#d4af37] to-[#8a703b] text-slate-950 font-bold shadow-xs' : 'text-amber-200/80 hover:text-white hover:bg-black/30'}`}>
                        Journal Entries & Vouchers
                      </Link>
                      <Link href="/backoffice/accounting/ledger" className={`block px-2.5 py-1 rounded transition-colors ${isLinkActive('/backoffice/accounting/ledger') ? 'bg-gradient-to-r from-[#d4af37] to-[#8a703b] text-slate-950 font-bold shadow-xs' : 'text-amber-200/80 hover:text-white hover:bg-black/30'}`}>
                        General Ledger & Trial Balance
                      </Link>
                      <Link href="/backoffice/accounting/cost-centers" className={`block px-2.5 py-1 rounded transition-colors ${isLinkActive('/backoffice/accounting/cost-centers') ? 'bg-gradient-to-r from-[#d4af37] to-[#8a703b] text-slate-950 font-bold shadow-xs' : 'text-amber-200/80 hover:text-white hover:bg-black/30'}`}>
                ...
                <div className="border border-[#b89542]/30 rounded-xl overflow-hidden bg-black/30 shadow-xs">
                  ...
                  {openSections.hr && (
                    <div className="pl-6 pr-2 py-1 space-y-0.5 border-t border-[#b89542]/20 bg-black/40 text-[11px]">
                      <Link href="/backoffice/hr" className={`block px-2.5 py-1 rounded transition-colors ${isLinkActive('/backoffice/hr') ? 'bg-gradient-to-r from-[#d4af37] to-[#8a703b] text-slate-950 font-bold shadow-xs' : 'text-amber-200/80 hover:text-white hover:bg-black/30'}`}>
                        Employees Directory
                      </Link>
                      <Link href="/backoffice/hr/attendance" className={`block px-2.5 py-1 rounded transition-colors ${isLinkActive('/backoffice/hr/attendance') ? 'bg-gradient-to-r from-[#d4af37] to-[#8a703b] text-slate-950 font-bold shadow-xs' : 'text-amber-200/80 hover:text-white hover:bg-black/30'}`}>
                        Attendance Logs & Overtime
                      </Link>
                      <Link href="/backoffice/hr/payroll" className={`block px-2.5 py-1 rounded transition-colors ${isLinkActive('/backoffice/hr/payroll') ? 'bg-gradient-to-r from-[#d4af37] to-[#8a703b] text-slate-950 font-bold shadow-xs' : 'text-amber-200/80 hover:text-white hover:bg-black/30'}`}>
