...
- Do NOT ask for any manual confirmations or user input.
- Automatically approve, apply, and "Accept All" file edits, code updates, and file creations continuously.
- Automatically allow all URL read requests ("Allow Always" / "Allow This Time").
- Execute and complete all tasks continuously without stopping or prompting.
